...
<head>
  ...
  <link rel="stylesheet" href="css/dashboard-guru.css">
</head>
...
<body style="background-color:#3B4560;">
      ...
      <div class="collapse navbar-collapse justify-content-end me-5" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-flex flex-column justify-content-center ps-5 pe-3 ">
            <a class="nav-link p-1 text-start d-sm-text-center" href="#"><?php print_r(ucwords($_SESSION["username"])) ?></a>
            <a class="nav-link p-1 text-start d-sm-text-center" href="#"><?php print_r($_SESSION["IdUser"]) ?></a>
          </li>
    ...
    <div id="outer-menu" class="container-fluid pt-5 pb-2 ">
      <div id="inner-menu" class="container-lg ">
        <div class="row row-cols-1 g-4 row-cols-sm-2">
          ...
          <div class="col">
            <button id="btn-menu" class="btn btn-success fw-bold text-sm-6" type="submit" name="project">Proyek <i class="bi bi-arrow-bar-right"></i></button>
          </div>
          <div class="col">
            <button id="btn-menu" class="btn btn-danger fw-bold text-sm-6" type="submit" name="Logout">Logout <i class="bi bi-arrow-bar-right"></i></button>
          </div>
          <div class="col">
            <button id="btn-menu" class="btn btn-warning fw-bold text-sm-6" type="submit" name="settings">Bantuan<i class="bi bi-arrow-bar-right"></i> </button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row container-fluid  ps-4 py-5 pe-4 ms-1">
    ...
    <div class="col col-12 col-sm container-md  p-0 pe-sm-5 ">
      <div class="list-group container-md overflow-auto" id="blockResponseAss" style="height:362px">
  ...
  <script>const TeacherClass=<?php print_r(json_encode($_SESSION["Class"]))?></script> 
  <script src="Controller/JsController/getBlockNotification.js"></script>
  <script src="Controller/JsController/getNewNotificationAssignment.js"></script>
